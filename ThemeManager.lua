...
local ThemeManager = {} do
	ThemeManager.Folder = 'AquaHook'
	ThemeManager.DefaultTheme = 'AquaHook'
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default'] 		= { 1, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"212121","AccentColor":"308b6d","BackgroundColor":"1e1e1e","OutlineColor":"252525"}') },
		['AquaHook'] 		= { 2, httpService:JSONDecode('{"FontColor":"ffffff","MainColor":"212121","AccentColor":"308b6d","BackgroundColor":"1e1e1e","OutlineColor":"252525"}') },
